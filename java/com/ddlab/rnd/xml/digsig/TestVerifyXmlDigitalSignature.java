...
public class TestVerifyXmlDigitalSignature {
    ...
    public static void testSignedXMLDoc() {
        ...
        System.out.println(signedXmlFilePath);
        
       // String publicCertificateFilePath = "keys" + File.separator + "ezswype.cer";
        String publicCertificateFilePath = "keys" + File.separator + "volt61_public.cer";
        try {
