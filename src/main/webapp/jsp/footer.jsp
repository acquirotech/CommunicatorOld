...
<!-- -----------------------------------js function -->
 <!-- footer content -->
               <footer>
                    <div class="">
                        <p class="pull-right">Acquiro Payments.
                            <span class="lead"> <i class="fa fa-paw"></i> CAS</span>
                        </p>
                    </div>
    ...
    <!-- flot js -->
    <!--[if lte IE 8]><script type="text/javascript" src="resources/js/excanvas.min.js"></script><![endif]-->
    ...
    <script src="resources/js/datatables/tools/js/dataTables.tableTools.js"></script>
    <script>
            $(document).ready(function () {
...
<script type="text/javascript">
					...
					<script type="text/javascript">
                        $(document).ready(function () {
                        	 $('#beneficiaryDate').daterangepicker({
                                 singleDatePicker: true,
                                 format: 'YYYY-MM-DD',
                                 calender_style: "picker_4",
                               }, function (start, end, label) {
...
<script type="text/javascript">
		                        $(document).ready(function () {
		                            $('#chequeDepositDate').daterangepicker({
		                                singleDatePicker: true,
		                                calender_style: "picker_4",
		                                 }, function (start, end, label) {
		                                 });
					...
					<script type="text/javascript">
                        $(document).ready(function () {
                            ...
                            $('#cashDate').daterangepicker({
                                singleDatePicker: true,
                                calender_style: "picker_4",
                              }, function (start, end, label) {
                              });
                            $('#validTil').daterangepicker({
                                singleDatePicker: true,
                                calender_style: "picker_4",
                                 }, function (start, end, label) {
                                 });
    ...
    <!-- worldmap -->
    <script type="text/javascript" src="resources/js/maps/jquery-jvectormap-2.0.1.min.js"></script>
    ...
    <!-- skycons -->
    <script src="resources/js/skycons/skycons.js"></script>
    <script>
